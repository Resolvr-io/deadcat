...
/**
 * Full-screen overlay loader rendered via portal.
 * Re-uses the existing `.deadcat-overlay` / `.deadcat-loader` CSS classes
 * defined in style.css so the animation stays identical to the vanilla version.
 */
export function OverlayLoader({ message }: OverlayLoaderProps) {
  return createPortal(
    <div className="deadcat-overlay">
...
// ── Inline SVGs (identical to loader.ts originals) ─────────────────
