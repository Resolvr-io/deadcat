...
diesel::table! {
    lmsr_pools (pool_id) {
        ...
        initial_reserve_yes_outpoint -> Nullable<Text>,
        initial_reserve_no_outpoint -> Nullable<Text>,
        initial_reserve_collateral_outpoint -> Nullable<Text>,
        ...
        params_json -> Text,
        lmsr_table_values_json -> Nullable<Text>,
        nostr_event_id -> Nullable<Text>,
        nostr_event_json -> Nullable<Text>,
        created_at -> Text,
        updated_at -> Text,
