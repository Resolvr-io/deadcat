...
mod tests {
    ...
    fn test_utxo(asset_id: [u8; 32], value: u64) -> UnblindedUtxo {
        test_utxo_with_vout(asset_id, value, 0)
    }

    fn test_utxo_with_vout(asset_id: [u8; 32], value: u64, vout: u32) -> UnblindedUtxo {
    ...
    fn initial_issuance_happy_path() {
        ...
        let params = initial_issuance::InitialIssuanceParams {
            ...
            fee_utxo: test_utxo_with_vout(p.collateral_asset_id, 500, 99),
            pairs: 10,
            fee_amount: 500,
    ...
    fn oracle_resolve_change_keeps_fee_last() {
        ...
        let params = oracle_resolve::OracleResolveParams {
            ...
            no_reissuance_utxo: test_utxo(p.no_reissuance_token, 1),
            collateral_utxo: test_utxo(p.collateral_asset_id, 5_000_000),
            fee_utxo: test_utxo_with_vout(p.collateral_asset_id, 500_000, 99),
            outcome_yes: true,
            fee_amount: 500,
