...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::fetch_follow_list,
            commands::follow_pubkey,
            commands::unfollow_pubkey,
            commands::fetch_mute_list,
            commands::mute_pubkey,
            commands::unmute_pubkey,
