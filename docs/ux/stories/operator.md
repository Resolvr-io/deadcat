...
Personas covered: **Pool Operator** and **Order Maker**. See [ux-design.md](../design.md) for persona definitions. Both personas require "Market maker mode" enabled in settings.
